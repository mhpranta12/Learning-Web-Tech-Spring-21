...
?>
            ...
            <table border ="1" width="900px">
                <tr width=100px> <td>No.</td> <td> Name </td> <td> Email</td> <td> Actions</td> </tr>
<?php
                ...
                $n=1;
                   ...
                   {
                   echo "<tr width=100>"; echo"<td>"; echo $n; echo"</td>"; echo "<td>"; echo"$check->name <br>"; echo " </td>"; echo" <td>"; echo "$check->email<br>"; echo "</td>"; 
